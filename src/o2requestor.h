...
public:
    ...
    /// When the access token expires and is refreshed, O2Requestor::retry() needs to update the Authentication HTTP
    /// header. In order to do so, O2Requestor needs to know the format of the Authentication HTTP header.
